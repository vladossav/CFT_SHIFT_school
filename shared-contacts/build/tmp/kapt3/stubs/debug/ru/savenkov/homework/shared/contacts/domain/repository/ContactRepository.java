...
public abstract interface ContactRepository {
    ...
    public abstract kotlinx.coroutines.flow.Flow<java.util.List<ru.savenkov.homework.shared.contacts.data.model.Contact>> getAll();
}